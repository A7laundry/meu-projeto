...
- [x] **AC9:** Interface funciona offline: ação salva em fila local e sincroniza ao reconectar
...
| 2026-02-28 | @dev Dex | AC9 concluído: offline via useOfflineAction + OfflineQueueBanner no sorting-form |
